...
int main() {
    ...
    if (CreateProcessW(L"D:\\5sem_BSTU\\OS\\lab6\\OS06_03A\\x64\\Debug\\OS06_03A.exe", NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &startupInfoA, &processInfoA)) {
        cout << "Process A created\n";
        processes[0] = processInfoA.hProcess;
    }
    else cout << "[ERROR] CreateProcessW for Process A\n";
    if (CreateProcessW(L"D:\\5sem_BSTU\\OS\\lab6\\OS06_03B\\x64\\Debug\\OS06_03B.exe", NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &startupInfoB, &processInfoB)) {
